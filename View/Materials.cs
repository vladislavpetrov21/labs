...
namespace View
{
    public partial class Materials : Form
    {
        ...
        private void Materials_Load(object sender, System.EventArgs e)
        {
        ...
        private void toolStripButtonAdd_Click(object sender, System.EventArgs e)
        {
           ...
           ";New=False;Version=3";
            ...
            MatchCollection matches = regex.Matches(maskedTextBox1.Text);
            if (matches.Count == 0)
            {
            ...
            if (Convert.ToString(maxValue) == "")
                maxValue = 0;
            string txtSQLQuery = "insert into Materials (id, Name, Price) values (" +
           (Convert.ToInt32(maxValue) + 1) + ", '" + textBox1.Text + "', '" + maskedTextBox1.Text + "')";
        ...
        private void toolStripButtonChange_Click(object sender, EventArgs e)
        {
            ...
            string changePrice = maskedTextBox1.Text;
            //обновление Name
            String selectCommand = "update Materials set Name='" + changeName + "'where id = " + valueId;
            String selectCom = "update Materials set Price='" + changePrice + "'where id = " + valueId;
            string ConnectionString = @"Data Source=" + sPath +
            ";New=False;Version=3";
            changeValue(ConnectionString, selectCommand);
            ...
            selectCommand = "select * from Materials";
            refreshForm(ConnectionString, selectCommand);
            selectCom = "select * from Materials";
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            maskedTextBox1.Text = dataGridView1[2, e.RowIndex].Value.ToString();
        }
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            string priceId = dataGridView1[2, CurrentRow].Value.ToString();
            maskedTextBox1.Text = priceId;
        }
